const About = {
  async render() {
    return `
        <div id="about">
        <article>
          <h1 class="judul">Apa itu Website Refood?</h1>
          <div class="informasi">
        ...
        <article>
          ...
          <div class="row">
            <div class="col-sm-4">
              <figure>
                <img id="rizky" class="image-profil" alt="Foto profil Rizky Rizaldi Kurniawan" />
                <figcaption>
            ...
            <div class="col-sm-4">
              <figure>
                <img class="image-profil" alt="Foto profil Kelvin Jaya Pratama" />
                <figcaption>
            ...
            <div class="col-sm-4">
              <figure>
                <img id="irfan" class="image-profil" alt="Foto profil Muhammad Irfan Abidin" />
                <figcaption>
